...
@Configuration
@OpenAPIDefinition(info = @Info(title = "ProductService API", version = "1.0", description = "Documentation ProductService API v1.0"), security = @SecurityRequirement(name = "bearerAuth"))
